  ...
  const NavbarTop = () => {
    return (
      ...
      >
       ...
       width="112%"     
       >
         <Text fontSize={"25px"} marginLeft="28px" paddingTop={"20px"}
          paddingBottom="20px"><h1>Covid Update</h1></Text>
        <Text fontSize={"20px"} color={"red.300"}>COVID-19 pandemic: India reports 163 fresh cases in last 24 hours, active tally come down to 3,380</Text>
          <Text>India recorded 163 new cases of the novel 
            coronavirus in the past 24 hours. According
             to the data shared by the Union Health Ministry
              today (December 23), the total recovery rate reached
               at around 98.80 per
             cent and total recoveries data reached to 4,41,42,608.
            </Text>
            <Text>
